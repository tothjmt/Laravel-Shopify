...
##Installation
####Require tothjmt/shopify in `composer.json`

Add `"tothjmt/shopify"` in your "require" object. With a blank Laravel install, it will look something like this:
...
In `app/config/app.php`, add `tothjmt\Shopify\ShopifyServiceProvider` to the end of the `providers` array.
